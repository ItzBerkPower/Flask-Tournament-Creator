...
class FlaskTestase(unittest.TestCase):
    ...
    def test_protected_page_before_login(self):
    ...
    def test_protected_page_after_login(self):
        ...
        self.assertIn(b'Your Profile', result.data)  # Ensure the user can access the duels page
    ...
    def test_non_existent_page(self):
        result = self.app.get('/register') # Any non-existent page can be placed here, I placed duels because most common one
